                    ...
                    <div class="row">
                        ...
                        <div class="toolbox-left">
                					<div class="toolbox-info">
                						Showing <span>18 of 100</span> Products
                            ...
                            <div class="products mb-3">
                                <div class="product product-list">
                                    <?php
                                    $select_products = mysqli_query($conn, "SELECT * FROM `products` LIMIT 12,6") or die('query failed');
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination">
                                <li class="page-item">
                                        <a class="page-link page-link-next" href="shop2.php" aria-label="Next">
                                     <span aria-hidden="true"><i class="icon-long-arrow-left"></i>Prev</span>
                                        </a>
                                    </li>
                                    <li class="page-item" aria-current="page"><a class="page-link" href="shop2.php">2</a></li>
                                    ...
                                    <li class="page-item">
                                        <a class="page-link page-link-next" href="shop4.php" aria-label="Next">
