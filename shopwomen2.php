                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="products mb-3">
                                <div class="product product-list">
                                    <?php
                                    $select_products = mysqli_query($conn, "SELECT * FROM `products` where `for` = 'Women' LIMIT 25,100") or die('query failed');
                                                ...
                                                <div class="row shadow">
                                                    <div class="col-6 col-lg-3">
                                                        <figure class="product-media">
                                                            <a href="#">
                                                                <img src="uploaded_img/<?php echo $fetch_products['image']; ?>" alt="" class="product-image image">
                                                            </a>
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination">
                                <li class="page-item">
                                        <a class="page-link page-link-next" href="shopwomen.php" aria-label="Next">
                                     <span aria-hidden="true"><i class="icon-long-arrow-left"></i>Prev</span>
                                        </a>
                                    </li>
                                    
                                    <li class="page-item  "   ><a class="page-link" href="shopwomen.php">1</a></li>
                                    <li class="page-item active "><a class="page-link" href="shopwomen2.php">2</a></li>
                                    <li class="page-item">
                                        <a class="page-link page-link-next" href="shopwomen2.php" aria-label="Next">
                                    ...
                                    <div class="collapse show" id="widget-1">
                                        <div class="widget-body">
                                            <div class="filter-items filter-items-count">
                                                ...
                                                <div class="filter-item">
                                                    <div class="custom-control custom-checkbox">
                                                    <a class="cate"  href="shopwallet.php">Wallets</a>
                                        ...
                                        <div class="widget-body">
                                            <div class="filter-items filter-items-count">
                                               ...
                                               <!-- End .filter-item -->
                                                ...
                                                <div class="filter-item">
                                                    <div class="custom-control custom-checkbox">
                                                    <a style="color:#363a5d !important ; font-weight:600;"   class="cate"  href="shopwomen.php">Womens</a>
