                    ...
                    <div class="row">
                        ...
                        <div class="toolbox-left">
                					<div class="toolbox-info">
                						Showing <span>6 of 100</span> Products
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination">
                                    <li class="page-item disabled">
                                        <a class="page-link page-link-prev" href="shop.php" aria-label="Previous" tabindex="-1" aria-disabled="true">
                                            <span aria-hidden="true"><i class="icon-long-arrow-left"></i></span>Prev
                                        </a>
                                    </li>
                                    <li class="page-item active" aria-current="page"><a class="page-link" href="shop.php">1</a></li>
