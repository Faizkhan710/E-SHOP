                    ...
                    <div class="row">
                        ...
                        <div class="toolbox-left">
                					<div class="toolbox-info">
                						Showing <span>100 of 100</span> Products
                            ...
                            <div class="products mb-3">
                                <div class="product product-list">
                                    <?php
                                    $select_products = mysqli_query($conn, "SELECT * FROM `products` LIMIT 96,4") or die('query failed');
                            ...
                            <nav aria-label="Page navigation">
                                ...
                                <li class="page-item">
                                    ...
                                    <li class="page-item active"><a class="page-link" href="shop17.php">17</a></li>
                                    <li class="page-item">
