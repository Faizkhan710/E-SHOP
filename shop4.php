                    ...
                    <div class="row">
                        ...
                        <div class="toolbox-left">
                					<div class="toolbox-info">
                						Showing <span>24 of 100</span> Products
                            ...
                            <div class="products mb-3">
                                <div class="product product-list">
                                    <?php
                                    $select_products = mysqli_query($conn, "SELECT * FROM `products` LIMIT 18,6") or die('query failed');
                            ...
                            <nav aria-label="Page navigation">
                                ...
                                <li class="page-item">
                                    ...
                                    <li class="page-item " aria-current="page"><a class="page-link" href="shop3.php">3</a></li>
                                    <li class="page-item active"   ><a class="page-link" href="shop4.php">4</a></li>
                                    <li class="page-item"><a class="page-link" href="shop5.php">5</a></li>
