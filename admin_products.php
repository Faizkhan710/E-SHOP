...
if (isset($_POST['add_product'])) {
    ...
    if (mysqli_num_rows($select_product_name) > 0) {
        ...
        $add_product_query = mysqli_query($conn, "INSERT INTO `products`(name, price, productId, productcode, discription, image, categroy,`for`) VALUES('$name', '$price',  '$productId', '$productcode', '$discription', '$image','$categroy','$for')") or die('query failed');
    ...
    <div class="d-flex align-items-stretch">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled">
                ...
                <li class="active"><a href="admin_products.php"> <i class="icon-padnote"></i>Products </a></li>
        ...
        <div class="page-content">
            ...
            <section class="add-products">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" name="productcode" class="box" placeholder="enter product code" required>
                    <input type="text" name="name" class="box" placeholder="enter product name" required>
                    <input type="text" name="discription" class="box" placeholder="enter product discription" required>
                    <input type="text" name="categroy" class="box" placeholder="enter product categroy" required>
                    <input type="text" name="`for`" class="box" placeholder="enter product for" required>
                            ...
                            ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center"> <a href="admin_products.php?update=<?php echo $fetch_products['id']; ?>" class="option-btn">update</a>
                                            </td>

                                            <td class="text-center"> <a href="admin_products.php?delete=<?php echo $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('delete this product?');">delete</a></td>
                                        </tr>
        ...
        <section class="edit-product-form">
            ...
            ?>
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <img class="ua" src="uploaded_img/<?php echo $fetch_update['image']; ?>" alt="">
