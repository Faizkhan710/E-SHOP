                        ...
                        <form action="" method="post">
                            <div class="row">
                                <div class="col-lg-9">
                                    ...
                                    <input min="0" name="flat" type="text" class="form-control" placeholder="House number and Street name" required>
                                    <input type="text" name="street" type="text" class="form-control" placeholder="Appartments, suite, unit etc ..." required>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="number" min="0" name="pin_code" type="text" class="form-control" required>
                                        </div><!-- End .col-sm-6 -->

                                        <div class="col-sm-6">
                                            <label>Phone *</label>
                                            <input name="number" type="tel" class="form-control" required>
                                        </div><!-- End .col-sm-6 -->

                                        <div class="inputBox">
                                            <span class="active" style="width:290px; margin-top:7px;">payment method :</span>
                                            <select style="font-size:17px;height:50px;" class="form-control" name="method">
                    ...
                    <div class="summary">
                        ...
                        <table class="table table-summary">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            <td><a href="#"><?php echo $fetch_cart['name']; ?> </a></td>
                                            <td><span>(<?php echo '$' . $fetch_cart['price'] . '/-' . ' x ' . $fetch_cart['quantity']; ?>)</span> </td>
                                        </tr>
                                <?php
                                    }
                                } else {
                        ...
                        <table class="table table-summary">
                            ...
                            <tbody>
                                ...
                                <tr class="summary-total">
                                    <td style="color:#363a5d; font-weight:500;">Total:</td>
                                    <td style="color:#363a5d; font-weight:500;"> <span style="color:#363a5d; font-weight:500;"> $<?php echo $grand_total; ?>/-</span> </td>
                                </tr><!-- End .summary-total -->

                            </tbody>
                        </table><!-- End .table table-summary -->

                        <button name="order_btn" type="submit" class="btn btn-outline-primary-2 btn-order btn-block">

                            <span type="submit" name="order_btn" class="btn-text">Place Order</span>
                            <span type="submit" name="order_btn" class="btn-hover-text">Proceed to Checkout</span>
                        </button>
                    </div><!-- End .summary -->
                </aside><!-- End .col-lg-3 -->
