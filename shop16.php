                    ...
                    <div class="row">
                        ...
                        <div class="toolbox-left">
                					<div class="toolbox-info">
                						Showing <span>96 of 100</span> Products
                            ...
                            <div class="products mb-3">
                                <div class="product product-list">
                                    <?php
                                    $select_products = mysqli_query($conn, "SELECT * FROM `products` LIMIT 90,6") or die('query failed');
                            ...
                            <nav aria-label="Page navigation">
                                ...
                                <li class="page-item">
                                    ...
                                    <li class="page-item " aria-current="page"><a class="page-link" href="shop15.php">15</a></li>
                                    <li class="page-item active"   ><a class="page-link" href="shop16.php">16</a></li>
                                    <li class="page-item"><a class="page-link" href="shop17.php">17</a></li>
                                    <li class="page-item">
                                        <a class="page-link page-link-next" href="shop17.php" aria-label="Next">
