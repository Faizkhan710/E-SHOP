    ...
    <div style="z-index: 5;" class="nav">
        ...
        <main class="main">
            <div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
                <div class="container">
                    <h1 class="page-title">Shopping Cart<span style="color:#363a5d;">Shop</span></h1>
                </div><!-- End .container -->
            </div><!-- End .page-header -->
                        ...
                        <div class="row">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td class="price-col">$<?php echo $fetch_cart['price']; ?></td>
                                                    <td class="quantity-col">
                                                        <div class="cart-product-quantity">
                                                            <form class="frr" action="" method="post">
                                                                <input type="hidden" name="cart_id" value="<?php echo $fetch_cart['id']; ?>">

                                                                <input class="qn" type="number" min="1" name="cart_quantity" value="<?php echo $fetch_cart['quantity']; ?>">

                                                                <button type="submit" name="update_cart" class="btn btn1 btn-outline-dark-2">
                                                                    <span>UPDATE CART</span></i>
                                                                </button>
                                                    ...
                                                    <td style="color:#363a5d;" class="total-col"> sub total : <span>$<?php echo $sub_total = ($fetch_cart['quantity'] * $fetch_cart['price']); ?></span>
                                                    </td>


                                                    <td class="remove-col"><a href="cart.php?delete=<?php echo $fetch_cart['id']; ?>" onclick="return confirm('delete this from cart?');"><button class="btn-remove"><i class="icon-close"></i></button></a></td>
                                                </tr>
                                        <?php
                            ...
                            <aside class="col-lg-3">
                                <div class="summary summary-cart">
                                    <h3 style="color:#363a5d;" class="summary-title">Cart Total</h3><!-- End .summary-title -->
                                    ...
                                    <table class="table table-summary">
                                        <tbody>
                                            ...
                                            <tr class="summary-total">
                                                <td style="color:#363a5d;">Total:</td>
                                                <td style="color:#363a5d;">$<?php echo $grand_total; ?></span></td>
