                ...
                <div class="bg-light-2 pt-6 pb-7 mb-6">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7 col-lg-4">
                                <div class="member member-2 text-center">
                                    ...
                                    <div class="member-content">
                                        <h3 class="member-title">Mohsin Sheraaz<span>Sales & Marketing Manager</span></h3><!-- End .member-title -->
                            ...
                            <div class="col-sm-7 col-lg-4">
                                <div class="member member-2 text-center">
                                    ...
                                    <div class="member-content">
                                        <h3 class="member-title">Asim khan<span>Sales & Marketing Manager</span></h3><!-- End .member-title -->
                                    </div><!-- End .member-content -->
                                </div><!-- End .member -->
                            </div><!-- End .col-lg-3 -->
                        ...
                        <div class="text-center mt-3">
                            <a href="index.php" class="btn btn-sm btn-minwidth-lg btn-outline-primary-2">
