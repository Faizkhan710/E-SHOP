...
<div style="z-index: 5;" class="nav">
    ...
    <div class="page-wrapper">
        ...
        <main class="main">
            <div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
                <div class="container">
                    <h1 style="color:#363a5d;" class="page-title">Search</h1>
                </div><!-- End .container -->
            </div><!-- End .page-header -->
   ...
   <form class="srch" action="" method="post">
      <input type="text" name="search" placeholder="search products..." class="box">
      <input type="submit" name="submit" value="search" class="ba">
   </form>
                                                ...
                                                <div class="row shadow">
                                                    ...
                                                    <div class="col-6 col-lg-3">
                                                        <figure class="product-media">
                                                            <a href="product.php?productid=<?php echo $fetch_product['id'] ?>">
                                                                <img src="uploaded_img/<?php echo $fetch_product['image']; ?>" alt="Product image" class="product-image">
                                                            </a>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="product-body product-action-inner">
                                                            ...
                                                            <div class="product-cat">
                                                                <a href=""><?php echo $fetch_product['categroy']; ?></a>
                                                            </div>
                                                          
                                                            <!-- End .product-cat -->
                                                            <h3 class="product-title"><a href="product.php?productid=<?php echo $fetch_product['id'] ?>"><?php echo $fetch_product['name']; ?></a></h3><!-- End .product-title -->
                                                            <input type="hidden" min="1" name="product_quantity" value="1" class="qty">


                                                            <div class="product-content">
                                                                <p><?php echo $fetch_product['discription']; ?></p>
