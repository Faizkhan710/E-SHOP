                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="products mb-3">
                                <div class="product product-list">
                                    <?php
                                    $select_products = mysqli_query($conn, "SELECT * FROM `products` where `for` = 'Men' LIMIT 15,100") or die('query failed');
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination">
                                <li class="page-item">
                                        <a class="page-link page-link-next" href="shopmen.php" aria-label="Next">
                                     <span aria-hidden="true"><i class="icon-long-arrow-left"></i>Prev</span>
                                        </a>
                                    </li>
                                    
                                    <li class="page-item "   ><a class="page-link" href="shopmen.php">1</a></li>
                                    <li class="page-item active"><a class="page-link" href="shopmen2.php">2</a></li>
                                    <li class="page-item">
                                        <a class="page-link page-link-next" href="shopmen2.php" aria-label="Next">
                                        ...
                                        <div class="widget-body">
                                            <div class="filter-items filter-items-count">
                                               ...
                                               <!-- End .filter-item -->
                                                <div class="filter-item">
                                                    <div class="custom-control custom-checkbox">
                                                    <a style="color:#363a5d !important ; font-weight:600;"   class="cate"  href="shopmen.php">Mens</a>
