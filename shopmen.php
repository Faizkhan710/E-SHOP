                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="products mb-3">
                                <div class="product product-list">
                                    <?php
                                    $select_products = mysqli_query($conn, "SELECT * FROM `products` where `for` = 'Men' LIMIT 15") or die('query failed');
                            ...
                            <nav aria-label="Page navigation">
                                ...
                                <li class="page-item">
                                    ...
                                    <li class="page-item active "   ><a class="page-link" href="shopmen.php">1</a></li>
                                    <li class="page-item "><a class="page-link" href="shopmen2.php">2</a></li>
                                    <li class="page-item">
