                    ...
                    <div class="row">
                        ...
                        <div class="toolbox-left">
                					<div class="toolbox-info">
                						Showing <span>36 of 100</span> Products
                            ...
                            <div class="products mb-3">
                                <div class="product product-list">
                                    <?php
                                    $select_products = mysqli_query($conn, "SELECT * FROM `products` LIMIT 30,6") or die('query failed');
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination">
                                <li class="page-item">
                                        <a class="page-link page-link-next" href="shop5.php" aria-label="Next">
                                     <span aria-hidden="true"><i class="icon-long-arrow-left"></i>Prev</span>
                                        </a>
                                    </li>
                                    <li class="page-item " aria-current="page"><a class="page-link" href="shop5.php">5</a></li>
                                    <li class="page-item active"   ><a class="page-link" href="shop6.php">6</a></li>
                                    <li class="page-item"><a class="page-link" href="shop7.php">7</a></li>
